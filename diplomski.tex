...
\zahvala{
Veliku  zahvalnost,  u  prvom  redu,  dugujem  svom  mentoru  prof.dr.sc.  Jadranku Matušku koji mi  je  omogućio  svu  potrebnu  opremu  i  pomogao  svojim  stručnim savjetima  pri  izradi  ovog  diplomskog rada.
...
\end{itemize}
U prethodnom poglavlju opisani je pretplatnik na čvor "control/drone\_input" (Arduino program), a u nastavku je programskim kodom opisani objavljivač na taj isti čvor (algoritam upravljanja). 
